...
function resetHandler(){
  ...
  return (
    <div className='w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10'>
      ...
      <div className='flex bg-[white] gap-12 py-3 justify-center rounded-sm text-[25px] text-[#344151]'>
      ...
      <button onClick={resetHandler} className='bg-[#0398d4] text-white px-5 py-2 roundex-sm text-lg'>reset</button>
    </div>
  );
}
